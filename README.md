...
本项目目前按个人硬件项目公开整理，资料可能还不完备。仓库中的工程文件、源码压缩包、照片和测试说明主要用于记录设计思路和阶段性验证结果，不代表可以直接用于量产、商业设备或安全关键场景。复现前请自行核对原理图、BOM、封装、功率走线、MOSFET 参数、驱动电源和固件配置；首次上电请使用限流电源，并先在空载或低负载条件下验证。电调测试涉及高速电机和大电流，调试时应拆除桨叶或负载机构，温升和长期稳定性仍有待更多工况验证。
